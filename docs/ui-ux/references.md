...
| The original phrase is not retained. Setup supports authenticated replacement, recovery saving, and local lock preferences.              | [Setup capabilities](../../apps/extension/src/extension/composition/vault-setup.capabilities.ts), [core workflow inventory](../core/workflows.md)                                                   |
| Entry-password and recovery-word copy reuse coordinated clipboard ownership and cleanup.                                                 | [CopyEntryPassword](../../packages/core/src/use-cases/clipboard/copy-entry-password.ts), [CopyRecoveryWords](../../packages/core/src/use-cases/clipboard/copy-recovery-words.ts)                    |
...
| Popup and Options are separate entrypoints; popup hands setup to the live Options flow.                                                  | [Popup root](../../apps/extension/src/extension/popup/popup.tsx), [options root](../../apps/extension/src/extension/options/options.tsx), [manifest](../../apps/extension/config/manifest.json)     |
