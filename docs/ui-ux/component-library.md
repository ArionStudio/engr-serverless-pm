...
| Website logins | Entry management for reviewed saved logins                                                          | Explicit Fill, opt-in detection, captured login review and session retention | EntrySelection, BrowserLoginsPanel, ActionFeedback                             |

Explicit popup Fill and opt-in Save/Update detection are implemented; see
[website logins](../architecture/website-logins.md) for browser and form limits. Current entry fields are login,
