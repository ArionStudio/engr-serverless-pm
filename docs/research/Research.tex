...
Template znajduje się w folderze \texttt{docs/aws/s3}.
Zawiera on konfigurację dla:
\begin{itemize}
    \item Bucketu S3 
    \item użytkownika IAM z kluczami dostępowymi
    \item polityki IAM ograniczającej dostęp do wskazanego prefiksu S3
\end{itemize}

Dokładny opis użycia template znajduje się w pliku \texttt{docs/aws/s3/README.md}.
