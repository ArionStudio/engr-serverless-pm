...
const featureIds = Object.fromEntries(
  "GeneratedVaultPasswordAction:F03 VaultApplication:S02 TagManagementView:S05 TagEditor:S05 FolderManagementView:S05 FolderManagementContent:S05 OrganizationManagementView:S05 TagMarker:P30 TagPill:P30 TagGroupHeading:P30 TagVisualPicker:P30 FolderEditor:P31 FolderTree:P31 FolderPicker:P31 FolderCount:P31 MoveFolderDialog:P31 SetupOrganization:S02 PasswordToolsPage:S02 DeviceManagementView:S02 VaultSettingsView:S02 SyncAccessKeys:S03 SyncManagement:S03 SyncTrustReview:S03 PopupSync:S01 PopupWorkspace:S01 PopupSettings:S01 PopupVaultAccess:S01 PopupEntries:S01 BrowserLoginsPanel:S01 EntryWorkspace:S02 SiteIcon:P11 SiteIconsProvider:P11 SiteIconSettings:P11 EntryEditor:F02 EntryDetails:P12 S3SetupGuide:S04 SetupLink:S04 SetupCopy:S04 SetupStep:S04 SetupChecklist:S04 SetupStage:S04 SetupLocation:S04 GuidancePanel:P29 AccessKeyInstructions:S04 SyncPage:S03 SetupRecoveryView:S02 SetupVaultAccess:S02 RecoverVaultAccess:S02 SetupWelcome:S02 SetupPassword:S02 SetupDevice:S02 SetupConnection:S02 ThemeProvider:P08 ThemeToggle:P08 OptionsView:S02 PopupView:S01 StepNavigation:P01 SetupLayout:P02 SettingsSection:P03 SafetyHelp:P04 TextField:B03 PasswordField:P05 PasswordStrengthFeedback:P06 LockDurationField:P07 FormActions:F01 FormFrame:F01 FormPassword:P05 SearchField:P10 EntryRow:P11 EntryList:P11 EntrySelection:P11 EntryTable:P11 SelectionCheckbox:P11 TagSelection:P27 EntryForm:F02 ActionFeedback:P26 CopyAction:P14 SecretField:P13 EmptyState:P15 DetailField:P12 VaultPicker:P09 UnlockForm:F01 PasswordChangeForm:F04 PasswordCreationForm:F03 SyncStatus:P21 ComparisonRow:P22 ResolutionSelector:P22 ReviewSummary:P22 SyncReview:P22 CredentialForm:F05 RecoveryPhraseGrid:P16 RecoveryExportChoices:P17 RecoveryGuide:P17 RecoveryWordInput:P18 RecoveryVerification:P19 LocalRecoveryForm:F06 DeviceSummary:P23 TransferInput:P24 TransferOutput:P24 DeviceSettingsForm:F07 DestructiveConfirmation:P25 AppNavigation:P28 VaultToolbar:P28 BoundedIntegerField:P20 GeneratorControls:P20 UsernameControls:P20 GeneratedValue:P20"
    .split(" ")
    .map((v) => v.split(":")),
);
